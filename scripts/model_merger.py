...
if __name__ == '__main__':
    ...
    #python3 scripts/model_merger.py --local_dir=checkpoints/verl/MATH-Qwen2.5-Math-7B-GRPO-exp5_mixed/global_step_77/actor
    #python3 scripts/model_merger.py --local_dir=checkpoints/verl/MATH-Qwen2.5-Math-7B-GRPO-exp4_sqrt1-p2/global_step_112/actor
    # python3 scripts/model_merger.py --local_dir=checkpoints/verl/MATH-Deepseekr1-7B-GRPO2/global_step_98/actor
    #python3 scripts/model_merger.py --local_dir=checkpoints/verl_grpo_example_geo3k/qwen2_5_vl_3b_grpo_20/global_step_35/actor
    #python3 scripts/model_merger.py --local_dir=checkpoints/verl_grpo_example_geo3k/qwen2_5_vl_3b_grpo_exp9-1_d02/global_step_75/actor
