...
export WANDB_DIR=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/native_mm/huyihao03/rl/zq/RLVR-Decomposed/wandb/MATH-Deepseekr1-7B-agrae2
...
# nohup sh run_deepseekr1-7b-agrae.sh > run_deepseekr1-7b-agrae.log 2>&1 &
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="MATH-Deepseekr1-7B-agrae2" \
    ...
    trainer.save_freq=7 \
    trainer.test_freq=7 \
    algorithm.grpo_weight=$grpo_weight \
